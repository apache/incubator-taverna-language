...
public class Ontology {
	...
	public static final String INSTANCE = "http://taverna.sf.net/2009/scufl2/instance#";
	public static final String name = CORE + "name";
	public static final String Named = CORE + "Named";
	public static final String WorkflowBean = CORE + "WorkflowBean";
	public static final String hasBinding = CORE + "hasBinding";
