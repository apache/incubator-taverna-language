...
public class WSDLXMSplitterParser extends AbstractActivityParser {
	...
	public static URI SPLITTER = WSDL.resolve("xsd-splitter");
	public static URI XML_INPUT_SPLITTER = SPLITTER.resolve("xsd-splitter/in");
	public static URI XML_OUTPUT_SPLITTER = SPLITTER.resolve("xsd-splitter/out");
